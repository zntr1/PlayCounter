import { createPersonalLibraryActions } from "./personalLibraryStore";
import type {
  ContributionCounts,
  ContributionStatus,
  DesktopViewId,
...
import { dismissLauncherGames } from "./library/libraryAutoAddState";
...
export const useAppStore = create<AppState>((set, get) => ({
  ...
  archivedPlaythroughSeconds: {},
  journalTarget: null,
  ...createPersonalLibraryActions(set, get, persistSoon),
  activeView: "now",
  libraryTab: "all",
  ...
  removeLibraryImport: (provider, externalId) => {
    // A removed launcher game must not be added back automatically.
    dismissLauncherGames([{ provider, externalId }]);
    set((state) => {
