  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Enable Controller navigation for an Xbox-compatible controller. Use the D-pad or left stick across the main menu and game cards, the right stick to scroll, A to enter or select, and B to go back. In My Games, tap Select/View to switch between standard and large TV-friendly cards. Search and advanced actions remain available with mouse and keyboard. Hold Select/View + RB for two seconds to bring PlayCounter forward on My Games. It only controls PlayCounter while this option is enabled.",
      },
    ],
  },
  {
