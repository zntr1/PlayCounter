  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        id: "set-forget",
        view: "games",
        anchor: a("demo-menu-launch-options"),
        retreatWhenMissing: a("demo-context-menu"),
        backTo: "learned",
        title: "Change or forget a launch file",
        body: "Right-click a game and open Launch options to set a different .exe or forget its launch file. If a saved file goes missing, PlayCounter quietly removes the broken Play option until you set a new one.",
      },
      {
        id: "limits",
        view: "settings",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        id: "matches",
        view: "games",
        anchor: a("demo-menu-matching"),
        retreatWhenMissing: a("demo-context-menu"),
        backTo: "open-menu",
        title: "Look the game up again",
        body: "Open Matching and choose Check for Matches to search IGDB and the Community database for this file name again. A match may have been added since, and a custom game can turn into a real one.",
      },
      {
        id: "wrong-match",
        view: "games",
        ...
        body: "The Matching submenu also has Report Wrong Match, which asks what the app really is and sends that in for review. Convert to Custom Game keeps it here under a name you pick yourself.",
      },
      {
        id: "remove",
        view: "games",
